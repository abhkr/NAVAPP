...
#define CONE_K2_COEFF             (92.0  / 315.0)
#define CONE_K3_COEFF             (54.0  / 315.0)
...
#define SCULL_K1_COEFF 		(214.0 / 315.0)
#define	SCULL_K2_COEFF  	(46.0 / 105.0)
#define SCULL_K3_COEFF 		(54.0 / 105.0)
